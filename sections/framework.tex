...
When a knife $r$ executes independently, it contributes a velocity
$f_r(x, a)$ that may push $x'(t)$ outside $T_K(x)$, and the
feedback map shrinks---possibly to the empty set.
