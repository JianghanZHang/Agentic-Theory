...
The two historical failure modes in \cref{sec:errorlog} are the two
ways the computational constraint breaks:
\begin{itemize}
...
\emph{factorized}---they use the infrastructure without the
...
\section{The dollar as knife precursor}\label{sec:dollar}
...
\section{The Atlantic triangular trade: a knife with no cut
