...
two-condition criterion (the sword). The framework produces three main
theorems (binary lifecycle, fixed-point impossibility, unconstrained
power paradox) and a central interpretive result: the sword is the mean
field.

The sword is not an intrinsic property of a resource. It is a
...
proposition, the sword becomes the min-cut, and the viable path becomes
the max-flow. The duality ``the sword is the mean'' is a restatement of
...
sword plays the role of the critical fluctuation.
...
The sword is the mean. Viability maintenance in sovereign systems
under finite-bandwidth detection is a mean-field phenomenon.
