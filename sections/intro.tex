...
finite object.
Eight appendices extend the analysis: historical sources~(\cref{app:sources}),
the complete puzzle solution~(\cref{app:solution}),
...
and a Gaokao reform analysis~(\cref{app:gaokao}).
