...
\begin{tikzpicture}[line cap=round, line join=round, scale=0.9]
  ...
  % 有質無形: the knife's definition in fictional representation
  % ═══════════════════════════════════════════════
  ...
  \draw[line width=0.35pt, knife!65]
    (-2.24, -11.75)
  ...
  \draw[line width=0.2pt, knife!45]
    (-5.3, -11.1)
    .. controls (-5.5, -10.9) and (-5.7, -11.15) .. (-5.85, -11.0);
  \draw[line width=0.1pt, knife!28]
    (-5.85, -11.0)
...
% knife = loss / exile / cutting / decline;
...
\textcolor{knife}{醉不成欢惨将别，别时茫茫江浸月。}\\[8pt]
% II. 闻声 · 演奏
...
\textcolor{knife}{弦弦掩抑声声思，似诉平生不得志。}\\[3pt]
...
\textcolor{knife}{冰泉冷涩弦凝绝，凝绝不通声暂歇。}\\[3pt]
\textcolor{sword}{别有幽愁暗恨生，此时无声胜有声。}\\[3pt]
\textcolor{knife}{银瓶乍破水浆迸，铁骑突出刀枪鸣。}\\[3pt]
\textcolor{knife}{曲终收拨当心画，四弦一声如裂帛。}\\[3pt]
...
\textcolor{knife}{今年欢笑复明年，秋月春风等闲度。}\\[3pt]
\textcolor{knife}{弟走从军阿姨死，暮去朝来颜色故。}\\[3pt]
\textcolor{knife}{门前冷落鞍马稀，老大嫁作商人妇。}\\[3pt]
\textcolor{knife}{商人重利轻别离，前月浮梁买茶去。}\\[3pt]
\textcolor{knife}{去来江口守空船，绕船月明江水寒。}\\[3pt]
\textcolor{knife}{夜深忽梦少年事，梦啼妆泪红阑干。}\\[8pt]
% IV. 白居易 + 共鸣
\textcolor{knife}{我闻琵琶已叹息，又闻此语重唧唧。}\\[3pt]
\textcolor{sword}{同是天涯沦落人，相逢何必曾相识！}\\[3pt]
\textcolor{knife}{我从去年辞帝京，谪居卧病浔阳城。}\\[3pt]
\textcolor{knife}{浔阳地僻无音乐，终岁不闻丝竹声。}\\[3pt]
\textcolor{knife}{住近湓江地低湿，黄芦苦竹绕宅生。}\\[3pt]
\textcolor{knife}{其间旦暮闻何物？杜鹃啼血猿哀鸣。}\\[3pt]
\textcolor{water}{春江花朝秋月夜，往往取酒还独倾。}\\[3pt]
\textcolor{knife}{岂无山歌与村笛，呕哑嘲哳难为听。}\\[3pt]
\textcolor{sword}{今夜闻君琵琶语，如听仙乐耳暂明。}\\[3pt]
\textcolor{sword}{莫辞更坐弹一曲，为君翻作《琵琶行》。}\\[8pt]
% V. 结
\textcolor{water}{感我此言良久立，却坐促弦弦转急。}\\[3pt]
\textcolor{knife}{凄凄不似向前声，满座重闻皆掩泣。}\\[3pt]
