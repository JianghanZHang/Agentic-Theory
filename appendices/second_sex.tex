...
\subsection{花木兰 --- the metastable crossing}
...
蔡文姬 is subcritical: the knife never breaks; transcendence exists
only in the gap (the poem, the voice).
花木兰 is a supercritical fluctuation: the knife breaks under
