...
\begin{tikzpicture}[line cap=round, line join=round]
  ...
  % ── Jaw (刀锋 — dao-edge piecewise lines) ──
  ...
  \draw[line width=0.1pt, black!50]
    (1.27, 5.0) -- (1.3, 4.25);
  % Needle tip
  \draw[line width=0.06pt, dao!30]
    (1.3, 4.25) -- (1.31, 4.05);
  % Thread trailing from eye of needle
  \draw[line width=0.05pt, dao!20]
